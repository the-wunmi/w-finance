...
class ExternalItemsControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "create" do
    ...
    assert_difference "ExternalItem.count", 1 do
      post external_items_url, params: {
        external_item: {
  ...
  test "destroy" do
    delete external_item_url(external_items(:one))
  ...
  test "sync" do
    ...
    post sync_external_item_url(external_item)

...
class ExternalAccount::Transactions::CategoryMatcherTest < ActiveSupport::TestCase
  setup do
    ...
    @matcher = ExternalAccount::Transactions::CategoryMatcher.new(@family.categories)
  end

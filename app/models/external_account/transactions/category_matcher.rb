...
#
# Automated category matching in the DoubleU app has a hierarchy:
...
class ExternalAccount::Transactions::CategoryMatcher
  include ExternalAccount::Transactions::CategoryTaxonomy

...
class Category
  ...
  module GeneratedAssociationMethods
    # This method is created by ActiveRecord on the `Category` class because it declared `has_many :budget_categories`.
    ...
    # This method is created by ActiveRecord on the `Category` class because it declared `has_many :import_mappings`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    ...
    # This method is created by ActiveRecord on the `Category` class because it declared `has_many :subcategories`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    sig { returns(::Category::PrivateCollectionProxy) }
    def subcategories; end

    sig { params(value: T::Enumerable[::Category]).void }
    def subcategories=(value); end

    sig { returns(T::Array[T.untyped]) }
    def subcategory_ids; end

    sig { params(ids: T::Array[T.untyped]).returns(T::Array[T.untyped]) }
    def subcategory_ids=(ids); end
    ...
    # This method is created by ActiveRecord on the `Category` class because it declared `has_many :transactions`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
  ...
  module GeneratedAttributeMethods
    ...
    sig { params(value: ::String).returns(::String) }
    def lucide_icon=(value); end

    sig { returns(T::Boolean) }
    def lucide_icon?; end

    sig { returns(T.nilable(::String)) }
    def lucide_icon_before_last_save; end

    sig { returns(T.untyped) }
    def lucide_icon_before_type_cast; end

    sig { returns(T::Boolean) }
    def lucide_icon_came_from_user?; end

    sig { returns(T.nilable([::String, ::String])) }
    def lucide_icon_change; end

    sig { returns(T.nilable([::String, ::String])) }
    def lucide_icon_change_to_be_saved; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def lucide_icon_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def lucide_icon_in_database; end

    sig { returns(T.nilable([::String, ::String])) }
    def lucide_icon_previous_change; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def lucide_icon_previously_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def lucide_icon_previously_was; end

    sig { returns(T.nilable(::String)) }
    def lucide_icon_was; end

    sig { void }
    def lucide_icon_will_change!; end
    ...
    sig { returns(T.nilable([::String, ::String])) }
    def saved_change_to_lucide_icon; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def saved_change_to_lucide_icon?(from: T.unsafe(nil), to: T.unsafe(nil)); end
    ...
    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def will_save_change_to_lucide_icon?(from: T.unsafe(nil), to: T.unsafe(nil)); end

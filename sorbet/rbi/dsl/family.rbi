...
class Family
  ...
  module GeneratedAssociationMethods
    ...
    sig { returns(T::Array[T.untyped]) }
    def external_item_ids; end

    sig { params(ids: T::Array[T.untyped]).returns(T::Array[T.untyped]) }
    def external_item_ids=(ids); end

    # This method is created by ActiveRecord on the `Family` class because it declared `has_many :external_items`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    sig { returns(::ExternalItem::PrivateCollectionProxy) }
    def external_items; end

    sig { params(value: T::Enumerable[::ExternalItem]).void }
    def external_items=(value); end

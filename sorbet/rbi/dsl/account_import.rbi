...
# This is an autogenerated file for dynamic methods in `AccountImport`.
# Please instead update this file by running `bin/tapioca dsl AccountImport`.
...
class AccountImport
  ...
  class << self
    sig do
      params(
        ...
        block: T.nilable(T.proc.params(object: ::AccountImport).void)
      ).returns(::AccountImport)
    end
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::AccountImport).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(T.any(Integer, Float, BigDecimal)) }
    def average(column_name); end

    sig { params(block: T.nilable(T.proc.params(object: ::AccountImport).void)).returns(::AccountImport) }
    sig do
      params(
        attributes: T::Array[T.untyped],
        block: T.nilable(T.proc.params(object: ::AccountImport).void)
      ).returns(T::Array[::AccountImport])
    end
    sig do
      params(
        attributes: T.untyped,
    ...
    sig { params(column_name: NilClass, block: T.proc.params(object: ::AccountImport).void).returns(Integer) }
    ...
    sig { returns(T::Array[::AccountImport]) }
    def destroy_all; end

    sig { params(conditions: T.untyped).returns(T::Boolean) }
    def exists?(conditions = :none); end

    sig { returns(T.nilable(::AccountImport)) }
    def fifth; end

    sig { returns(::AccountImport) }
    def fifth!; end
    ...
    sig do
      ...
      ).returns(T::Enumerable[::AccountImport])
    end
    sig do
      params(
        args: NilClass,
        block: T.proc.params(object: ::AccountImport).void
      ).returns(T.nilable(::AccountImport))
    end
    def find(args = nil, &block); end

    sig { params(args: T.untyped).returns(T.nilable(::AccountImport)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::AccountImport) }
    def find_by!(*args); end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol
      ).returns(T::Enumerator[::AccountImport])
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.proc.params(object: T::Array[::AccountImport]).void
      ).void
    end
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol
      ).returns(T::Enumerator[T::Enumerator[::AccountImport]])
    end
    ...
    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(T.nilable(::AccountImport)) }
    def find_signed(signed_id, purpose: nil); end

    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(::AccountImport) }
    def find_signed!(signed_id, purpose: nil); end

    sig { params(arg: T.untyped, args: T.untyped).returns(::AccountImport) }
    def find_sole_by(arg, *args); end

    sig { returns(T.nilable(::AccountImport)) }
    sig { params(limit: Integer).returns(T::Array[::AccountImport]) }
    ...
    sig do
      type_parameters(:U)
        .params(
          ...
          block: T.proc.params(object: ::AccountImport).returns(T.type_parameter(:U))
  ...
  module GeneratedAssociationRelationMethods
    ...
    sig { params(blk: T.proc.params(record: ::AccountImport).returns(BasicObject)).returns(T::Array[::AccountImport]) }
  ...
  class PrivateAssociationRelation < ::ActiveRecord::AssociationRelation
    ...
    Elem = type_member { { fixed: ::AccountImport } }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::AccountImport, T::Enumerable[T.any(::AccountImport, T::Enumerable[::AccountImport])])
    ...
    sig do
      params(
        other_array: T.any(::AccountImport, T::Enumerable[T.any(::AccountImport, T::Enumerable[::AccountImport])])
      ).returns(T::Array[::AccountImport])
    end

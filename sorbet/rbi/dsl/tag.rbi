...
class Tag
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Tag` class because it declared `has_many :import_mappings`.
    ...
    # This method is created by ActiveRecord on the `Tag` class because it declared `has_many :transactions, through: :taggings`.

...
module Lookbook
  class << self
    ...
    # @param opts [Hash] Set of panel options
    #
    # source://lookbook//lib/lookbook.rb#230
    ...
    # @param opts [Hash] Set of panel options
    #
    # source://lookbook//lib/lookbook.rb#229
    ...
    # @param opts [Hash] Set of default options to be passed to the input. Any supplied param options will override these values
    #
    # source://lookbook//lib/lookbook.rb#228
    ...
    # @yield [tag] The custom tag instance
    #
    # source://lookbook//lib/lookbook.rb#231
...
# source://lookbook//lib/lookbook/services/templates/action_view_config_handler.rb#2
class Lookbook::ActionViewConfigHandler < ::Lookbook::Service
  # @return [ActionViewConfigHandler] a new instance of ActionViewConfigHandler
  #
  # source://lookbook//lib/lookbook/services/templates/action_view_config_handler.rb#5
  def initialize(disable_annotations: T.unsafe(nil), disable_partial_prefixes: T.unsafe(nil)); end

  # source://lookbook//lib/lookbook/services/templates/action_view_config_handler.rb#10
  def call; end

  # Returns the value of attribute disable_annotations.
  #
  # source://lookbook//lib/lookbook/services/templates/action_view_config_handler.rb#3
  def disable_annotations; end

  # Returns the value of attribute disable_partial_prefixes.
  #
  # source://lookbook//lib/lookbook/services/templates/action_view_config_handler.rb#3
  ...
  # source://lookbook//lib/lookbook/services/templates/action_view_config_handler.rb#22
  def handle_annotations; end

  # source://lookbook//lib/lookbook/services/templates/action_view_config_handler.rb#36
  def handle_partial_prefixes; end

  # source://lookbook//lib/lookbook/services/templates/action_view_config_handler.rb#29
  def restore_annotations; end

  # source://lookbook//lib/lookbook/services/templates/action_view_config_handler.rb#43
...
class Lookbook::ConfigStore
  ...
  # source://lookbook//lib/lookbook/stores/config_store.rb#23
  ...
  # @api public
  #
  # source://lookbook//lib/lookbook/stores/config_store.rb#66
  ...
  # @api public
  #
  # source://lookbook//lib/lookbook/stores/config_store.rb#83
  ...
  # @api public
  #
  # source://lookbook//lib/lookbook/stores/config_store.rb#70
  ...
  # @api public
  #
  # source://lookbook//lib/lookbook/stores/config_store.rb#105
  ...
  class << self
    # @api public
    #
    # source://lookbook//lib/lookbook/stores/config_store.rb#99
    def default_config(env: T.unsafe(nil)); end

    # @api public
    #
    # source://lookbook//lib/lookbook/stores/config_store.rb#95
...
class Lookbook::CustomTag < ::Lookbook::YardTag
  ...
  # source://lookbook//lib/lookbook/tags/custom_tag.rb#28
  def opts; end
  ...
  #
  # source://lookbook//lib/lookbook/tags/custom_tag.rb#27
  def tag_body; end
...
class Lookbook::Engine < ::Rails::Engine
  # source://lookbook//lib/lookbook/engine.rb#109
  def opts; end

  # source://lookbook//lib/lookbook/engine.rb#113
  def parser; end
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://lookbook//lib/lookbook/engine.rb#136
    def auto_refresh?; end

    # source://lookbook//lib/lookbook/engine.rb#199
    def component_paths; end

    # source://lookbook//lib/lookbook/engine.rb#284
    def files_changed(modified, added, removed); end

    # source://lookbook//lib/lookbook/engine.rb#171
    def hooks; end

    # source://lookbook//lib/lookbook/engine.rb#181
    def host_app_path; end

    # source://lookbook//lib/lookbook/engine.rb#185
    def host_config; end

    # source://lookbook//lib/lookbook/engine.rb#163
    def inputs; end

    # source://lookbook//lib/lookbook/engine.rb#270
    def load_pages(changes = T.unsafe(nil)); end

    # source://lookbook//lib/lookbook/engine.rb#260
    def load_previews(changes = T.unsafe(nil)); end

    # source://lookbook//lib/lookbook/engine.rb#124
    def mount_path; end

    # @return [Boolean]
    #
    # source://lookbook//lib/lookbook/engine.rb#128
    def mounted?; end

    # source://lookbook//lib/lookbook/engine.rb#277
    def notify_clients(changes = T.unsafe(nil)); end

    # source://lookbook//lib/lookbook/engine.rb#206
    def page_paths; end

    # source://lookbook//lib/lookbook/engine.rb#210
    def page_watch_paths; end

    # source://lookbook//lib/lookbook/engine.rb#223
    def pages; end

    # source://lookbook//lib/lookbook/engine.rb#159
    def panels; end

    # source://lookbook//lib/lookbook/engine.rb#255
    ...
    # source://lookbook//lib/lookbook/engine.rb#212
    def preview_paths; end

    # source://lookbook//lib/lookbook/engine.rb#216
    def preview_watch_paths; end

    # source://lookbook//lib/lookbook/engine.rb#239
    def previews; end
    ...
    # source://lookbook//lib/lookbook/engine.rb#167
    def tags; end

    # source://lookbook//lib/lookbook/engine.rb#155
    def theme; end

    # source://lookbook//lib/lookbook/engine.rb#189
    def view_paths; end

    # source://lookbook//lib/lookbook/engine.rb#147
    def websocket; end
  end
end
...
class Lookbook::Entity
  ...
  # source://lookbook//lib/lookbook/entities/entity.rb#7
  def default_url_options; end
  ...
  # @return [String] The lookup path
  #
  # source://lookbook//lib/lookbook/entities/entity.rb#65
...
class Lookbook::EntityCollection
  ...
  # source://lookbook//lib/lookbook/entities/collections/entity_collection.rb#5
  def method_missing(method, *_arg1, **_arg2, &_arg3); end
...
class Lookbook::HiddenTag < ::Lookbook::YardTag
  # source://lookbook//lib/lookbook/tags/hidden_tag.rb#11
  def to_bool; end
...
class Lookbook::NullWebsocket < ::Lookbook::NullObject
  ...
  # @return [Boolean]
  #
  # source://lookbook//lib/lookbook/support/null_websocket.rb#7
  def mounted?; end
end
...
class Lookbook::PageCollection < ::Lookbook::EntityCollection
  ...
  # source://lookbook//lib/lookbook/entities/collections/page_collection.rb#3
  def entities; end
...
class Lookbook::PageEntity < ::Lookbook::Entity
  ...
  # source://lookbook//lib/lookbook/entities/page_entity.rb#7
  def <=>(other); end
  ...
  # source://lookbook//lib/lookbook/entities/page_entity.rb#6
  ...
  # @return [String] URL path
  #
  # source://lookbook//lib/lookbook/entities/page_entity.rb#102
  def url_path; end
...
class Lookbook::PageSectionEntity < ::Lookbook::PageEntity
  ...
  # @api private
  #
  # source://lookbook//lib/lookbook/entities/page_section_entity.rb#36
  def page; end
...
class Lookbook::PanelStore
  ...
  # source://lookbook//lib/lookbook/stores/panel_store.rb#66
  def all; end
...
class Lookbook::Preview
  ...
  # source://lookbook//lib/lookbook/preview.rb#37
...
class Lookbook::PreviewCollection < ::Lookbook::EntityCollection
  ...
  # source://lookbook//lib/lookbook/entities/collections/preview_collection.rb#3
  def entities; end
...
class Lookbook::PreviewEntity < ::Lookbook::Entity
  ...
  # source://lookbook//lib/lookbook/entities/preview_entity.rb#8
  def <=>(other); end
  ...
  # source://lookbook//lib/lookbook/entities/preview_entity.rb#7
  def base_directories; end

  # @api private
  # @api private
  #
  # source://lookbook//lib/lookbook/entities/preview_entity.rb#119
  def component; end
  ...
  #
  # source://lookbook//lib/lookbook/entities/preview_entity.rb#111
  def components; end
  ...
  #
  # source://lookbook//lib/lookbook/entities/preview_entity.rb#56
  ...
  #
  # source://lookbook//lib/lookbook/entities/preview_entity.rb#41
  ...
  # source://lookbook//lib/lookbook/entities/preview_entity.rb#6
  ...
  # @return [String] URL path
  #
  # source://lookbook//lib/lookbook/entities/preview_entity.rb#132
  def url_path; end
...
class Lookbook::PriorityTag < ::Lookbook::YardTag
  # source://lookbook//lib/lookbook/tags/priority_tag.rb#14
  def to_i; end
...
class Lookbook::Reloaders
  ...
  # source://lookbook//lib/lookbook/reloaders.rb#23
  def execute(name = T.unsafe(nil)); end

  # source://lookbook//lib/lookbook/reloaders.rb#29
...
class Lookbook::Reloaders::Reloader
  ...
  #
  # source://lookbook//lib/lookbook/reloaders.rb#40
  def initialize(name, directories, extensions, &callback); end

  # Returns the value of attribute callback.
  #
  # source://lookbook//lib/lookbook/reloaders.rb#37
  def callback; end
  ...
  # source://lookbook//lib/lookbook/reloaders.rb#35
  ...
  #
  # source://lookbook//lib/lookbook/reloaders.rb#38
  ...
  # @return [Boolean]
  #
  # source://lookbook//lib/lookbook/reloaders.rb#48
  def watching?(changes); end

  protected

  # source://lookbook//lib/lookbook/reloaders.rb#61
  def file_watcher; end
end
...
class Lookbook::RenderableEntity < ::Lookbook::Entity
  ...
  # source://lookbook//lib/lookbook/entities/renderable_entity.rb#7
  def base_directories; end
...
class Lookbook::RenderedScenarioEntity
  ...
  # source://lookbook//lib/lookbook/entities/rendered_scenario_entity.rb#11
  def method_missing(method, *_arg1, **_arg2, &_arg3); end
...
class Lookbook::ScenarioEntity < ::Lookbook::Entity
  ...
  # source://lookbook//lib/lookbook/entities/scenario_entity.rb#8
  def <=>(other); end
  ...
  #
  # source://lookbook//lib/lookbook/entities/scenario_entity.rb#91
  def component; end

  # @api private
  # @api private
  #
  # source://lookbook//lib/lookbook/entities/scenario_entity.rb#76
  def components; end

  # source://lookbook//lib/lookbook/entities/scenario_entity.rb#6
  ...
  # @api private
  #
  # source://lookbook//lib/lookbook/entities/scenario_entity.rb#141
  def examples(*args, **_arg1, &block); end

  # source://lookbook//lib/lookbook/entities/scenario_entity.rb#10
  def group(*_arg0, **_arg1, &_arg2); end

  # source://lookbook//lib/lookbook/entities/scenario_entity.rb#7
  def has_tag?(*_arg0, **_arg1, &_arg2); end
  ...
  # @api public
  #
  # source://lookbook//lib/lookbook/entities/scenario_entity.rb#140
  ...
  #
  # source://lookbook//lib/lookbook/entities/scenario_entity.rb#18
  def parent; end
  ...
  # @return [String] URL path
  #
  # source://lookbook//lib/lookbook/entities/scenario_entity.rb#142
  def url_path; end
...
class Lookbook::ScenarioGroupEntity < ::Lookbook::Entity
  ...
  # source://lookbook//lib/lookbook/entities/scenario_group_entity.rb#6
  def <=>(other); end
  ...
  #
  # source://lookbook//lib/lookbook/entities/scenario_group_entity.rb#67
  def components; end
  ...
  # @return [PreviewEntity] The parent preview entity
  #
  # source://lookbook//lib/lookbook/entities/scenario_group_entity.rb#23
  def parent; end
  ...
  # @return [String] URL path
  #
  # source://lookbook//lib/lookbook/entities/scenario_group_entity.rb#109
  def url_path; end
...
class Lookbook::Theme
  ...
  # source://lookbook//lib/lookbook/theme.rb#38
  def favicon_dark_mode; end

  # source://lookbook//lib/lookbook/theme.rb#32
  def favicon_light_mode; end

  # source://lookbook//lib/lookbook/theme.rb#44
  def to_css; end

  class << self
    # @return [Boolean]
    #
    # source://lookbook//lib/lookbook/theme.rb#58
...
class Lookbook::TreeNode
  ...
  # source://lookbook//lib/lookbook/support/tree_node.rb#6
  def method_missing(method, *_arg1, **_arg2, &_arg3); end
...
class Lookbook::YardTag < ::YARD::Tags::Tag
  ...
  #
  # source://lookbook//lib/lookbook/tags/yard_tag.rb#27
  def value; end
...
class Redcarpet::Render::Base; end
class Redcarpet::Render::HTML < ::Redcarpet::Render::Base; end

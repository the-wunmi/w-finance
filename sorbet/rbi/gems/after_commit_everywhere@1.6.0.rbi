...
class AfterCommitEverywhere::Wrap
  ...
  #
  # source://after_commit_everywhere//lib/after_commit_everywhere/wrap.rb#38
  def add_to_transaction(*_arg0); end

  # source://after_commit_everywhere//lib/after_commit_everywhere/wrap.rb#19
  def before_committed!(*_arg0); end

  # source://after_commit_everywhere//lib/after_commit_everywhere/wrap.rb#27
  def committed!(should_run_callbacks: T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://after_commit_everywhere//lib/after_commit_everywhere/wrap.rb#14
  def has_transactional_callbacks?; end

  # source://after_commit_everywhere//lib/after_commit_everywhere/wrap.rb#33
  def rolledback!(*_arg0); end

  # @return [Boolean]
  #
  # source://after_commit_everywhere//lib/after_commit_everywhere/wrap.rb#23

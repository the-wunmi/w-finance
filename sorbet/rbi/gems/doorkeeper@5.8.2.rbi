...
module Doorkeeper
  class << self
    ...
    #
    # source://doorkeeper//lib/doorkeeper.rb#141
    def config; end
...
class Doorkeeper::AccessGrant < ::ActiveRecord::Base
  ...
  # source://doorkeeper//lib/doorkeeper/orm/active_record/access_grant.rb#7
...
class Doorkeeper::AccessToken < ::ActiveRecord::Base
  ...
  # source://doorkeeper//lib/doorkeeper/orm/active_record/access_token.rb#7
  def autosave_associated_records_for_application(*args); end
...
class Doorkeeper::Application < ::ActiveRecord::Base
  ...
  # source://doorkeeper//lib/doorkeeper/orm/active_record/application.rb#8
...
class Doorkeeper::Config
  ...
  # source://doorkeeper//lib/doorkeeper/config.rb#394
  ...
  # source://doorkeeper//lib/doorkeeper/config.rb#391
  def access_token_class(*_args); end

  # source://doorkeeper//lib/doorkeeper/config.rb#250
  def access_token_expires_in(*_args); end

  # source://doorkeeper//lib/doorkeeper/config.rb#345
  ...
  # source://doorkeeper//lib/doorkeeper/config.rb#242
  def after_successful_authorization(*_args); end

  # source://doorkeeper//lib/doorkeeper/config.rb#245
  def after_successful_strategy_response(*_args); end

  # source://doorkeeper//lib/doorkeeper/config.rb#403
  ...
  #
  # source://doorkeeper//lib/doorkeeper/config.rb#309
  ...
  # source://doorkeeper//lib/doorkeeper/config.rb#397
  ...
  # source://doorkeeper//lib/doorkeeper/config.rb#363
  ...
  # source://doorkeeper//lib/doorkeeper/config.rb#221
  def authenticate_admin(*_args); end

  # source://doorkeeper//lib/doorkeeper/config.rb#211
  def authenticate_resource_owner(*_args); end

  # source://doorkeeper//lib/doorkeeper/config.rb#252
  ...
  # source://doorkeeper//lib/doorkeeper/config.rb#282
  def authorize_resource_owner_for_client(*_args); end

  # source://doorkeeper//lib/doorkeeper/config.rb#379
  def base_controller(*_args); end

  # source://doorkeeper//lib/doorkeeper/config.rb#388
  def base_metal_controller(*_args); end

  # source://doorkeeper//lib/doorkeeper/config.rb#241
  def before_successful_authorization(*_args); end

  # source://doorkeeper//lib/doorkeeper/config.rb#244
  ...
  # source://doorkeeper//lib/doorkeeper/config.rb#354
  def custom_access_token_attributes(*_args); end

  # source://doorkeeper//lib/doorkeeper/config.rb#251
  def custom_access_token_expires_in(*_args); end

  # source://doorkeeper//lib/doorkeeper/config.rb#247
  def custom_introspection_response(*_args); end

  # source://doorkeeper//lib/doorkeeper/config.rb#372
  ...
  # source://doorkeeper//lib/doorkeeper/config.rb#316
  ...
  # source://doorkeeper//lib/doorkeeper/config.rb#337
  def force_ssl_in_redirect_uri(*_args); end

  # source://doorkeeper//lib/doorkeeper/config.rb#255
  def grant_flows(*_args); end

  # source://doorkeeper//lib/doorkeeper/config.rb#257
  def handle_auth_errors(*_args); end

  # source://doorkeeper//lib/doorkeeper/config.rb#620
  def native_authorization_code_route; end

  # source://doorkeeper//lib/doorkeeper/config.rb#254
  ...
  # source://doorkeeper//lib/doorkeeper/config.rb#253
  def orm(*_args); end

  # source://doorkeeper//lib/doorkeeper/config.rb#256
  ...
  # source://doorkeeper//lib/doorkeeper/config.rb#322
  def realm(*_args); end
  ...
  # source://doorkeeper//lib/doorkeeper/config.rb#231
  ...
  # source://doorkeeper//lib/doorkeeper/config.rb#249
  def skip_authorization(*_args); end

  # source://doorkeeper//lib/doorkeeper/config.rb#278
  ...
  # source://doorkeeper//lib/doorkeeper/config.rb#258
  def token_lookup_batch_size(*_args); end

  # source://doorkeeper//lib/doorkeeper/config.rb#264
...
# source://doorkeeper//lib/doorkeeper/errors.rb#77
...
# source://doorkeeper//lib/doorkeeper/errors.rb#80
...
# source://doorkeeper//lib/doorkeeper/errors.rb#73
...
class Doorkeeper::OAuth::AuthorizationCodeRequest < ::Doorkeeper::OAuth::BaseRequest
  ...
  # source://doorkeeper//lib/doorkeeper/oauth/authorization_code_request.rb#107
  def generate_code_challenge(code_verifier); end
  ...
  # source://doorkeeper//lib/doorkeeper/oauth/authorization_code_request.rb#119
  def revoke_previous_tokens(application, resource_owner); end

  # source://doorkeeper//lib/doorkeeper/oauth/authorization_code_request.rb#75
  def validate_client; end

  # if either side (server or client) request PKCE, check the verifier
  # against the DB - if PKCE is supported
  #
  # source://doorkeeper//lib/doorkeeper/oauth/authorization_code_request.rb#94
  ...
  # source://doorkeeper//lib/doorkeeper/oauth/authorization_code_request.rb#85
...
class Doorkeeper::OAuth::ClientCredentialsRequest < ::Doorkeeper::OAuth::BaseRequest
  ...
  # Returns the value of attribute response.
  #
  # source://doorkeeper//lib/doorkeeper/oauth/client_credentials_request.rb#8
...
class Doorkeeper::OAuth::PreAuthorization
  ...
  #
  # source://doorkeeper//lib/doorkeeper/oauth/pre_authorization.rb#25
  def initialize(server, parameters = T.unsafe(nil), resource_owner = T.unsafe(nil)); end

  # source://doorkeeper//lib/doorkeeper/oauth/pre_authorization.rb#62
  def as_json(_options = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://doorkeeper//lib/doorkeeper/oauth/pre_authorization.rb#39
  ...
  # source://doorkeeper//lib/doorkeeper/oauth/pre_authorization.rb#51
  def error_response; end

  # @return [Boolean]
  #
  # source://doorkeeper//lib/doorkeeper/oauth/pre_authorization.rb#66
  ...
  # source://doorkeeper//lib/doorkeeper/oauth/pre_authorization.rb#47
  def scope; end

  # source://doorkeeper//lib/doorkeeper/oauth/pre_authorization.rb#43
  def scopes; end
  ...
  # source://doorkeeper//lib/doorkeeper/oauth/pre_authorization.rb#74
  def build_scopes; end
  ...
  # source://doorkeeper//lib/doorkeeper/oauth/pre_authorization.rb#174
  def pre_auth_hash; end

  # @return [Boolean]
  #
  # source://doorkeeper//lib/doorkeeper/oauth/pre_authorization.rb#164
  def response_on_fragment?; end
  ...
  # source://doorkeeper//lib/doorkeeper/oauth/pre_authorization.rb#88
  def validate_client; end

  # source://doorkeeper//lib/doorkeeper/oauth/pre_authorization.rb#83
  def validate_client_id; end

  # source://doorkeeper//lib/doorkeeper/oauth/pre_authorization.rb#93
  def validate_client_supports_grant_flow; end

  # source://doorkeeper//lib/doorkeeper/oauth/pre_authorization.rb#148
  def validate_code_challenge; end

  # source://doorkeeper//lib/doorkeeper/oauth/pre_authorization.rb#157
  def validate_code_challenge_method; end

  # source://doorkeeper//lib/doorkeeper/oauth/pre_authorization.rb#111
  def validate_params; end

  # source://doorkeeper//lib/doorkeeper/oauth/pre_authorization.rb#102
  def validate_redirect_uri; end

  # source://doorkeeper//lib/doorkeeper/oauth/pre_authorization.rb#97
  def validate_resource_owner_authorize_for_client; end

  # source://doorkeeper//lib/doorkeeper/oauth/pre_authorization.rb#130
  def validate_response_mode; end

  # source://doorkeeper//lib/doorkeeper/oauth/pre_authorization.rb#121
  def validate_response_type; end

  # source://doorkeeper//lib/doorkeeper/oauth/pre_authorization.rb#139
  def validate_scopes; end
end
...
class Doorkeeper::OAuth::Scopes
  ...
  # @return [Boolean]
  #
  # source://doorkeeper//lib/doorkeeper/oauth/scopes.rb#59
...
module Doorkeeper::Rails::Routes::Registry
  ...
  #
  # source://doorkeeper//lib/doorkeeper/rails/routes/registry.rb#41

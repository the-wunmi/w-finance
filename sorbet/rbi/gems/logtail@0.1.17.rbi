...
class Logtail::Config
  ...
  class << self
    ...
    # source://logtail//lib/logtail/config.rb#31
    def allocate; end
...
class Logtail::Event
  ...
  # source://logtail//lib/logtail/event.rb#26
  def to_h; end
...
class Logtail::LogDevices::HTTP
  ...
  # @return [HTTP] a new instance of HTTP
  #
  # source://logtail//lib/logtail/log_devices/http.rb#71
  def initialize(source_token, options = T.unsafe(nil)); end

  # Closes the log device, cleans up, and attempts one last delivery.
  #
  # source://logtail//lib/logtail/log_devices/http.rb#123
  def close; end

  # source://logtail//lib/logtail/log_devices/http.rb#134
  ...
  #
  # source://logtail//lib/logtail/log_devices/http.rb#116
  def flush; end

  # source://logtail//lib/logtail/log_devices/http.rb#153
  ...
  #
  # source://logtail//lib/logtail/log_devices/http.rb#95
  def write(msg); end
  ...
  #
  # source://logtail//lib/logtail/log_devices/http.rb#381
  def authorization_payload; end

  # Builds an `Net::HTTP` object to deliver requests over.
  #
  # source://logtail//lib/logtail/log_devices/http.rb#290
  def build_http; end

  # Builds an HTTP request based on the current messages queued.
  #
  # source://logtail//lib/logtail/log_devices/http.rb#204
  ...
  #
  # source://logtail//lib/logtail/log_devices/http.rb#328
  ...
  #
  # source://logtail//lib/logtail/log_devices/http.rb#191
  ...
  # imposed limit.
  #
  # source://logtail//lib/logtail/log_devices/http.rb#231
  def flush_async; end

  # source://logtail//lib/logtail/log_devices/http.rb#216
  ...
  #
  # source://logtail//lib/logtail/log_devices/http.rb#264
  ...
  # @return [Boolean]
  #
  # source://logtail//lib/logtail/log_devices/http.rb#285
  def intervaled_flush_ready?; end

  # Creates a loop that processes the `@request_queue` on an interval.
  #
  # source://logtail//lib/logtail/log_devices/http.rb#305
  ...
  #
  # source://logtail//lib/logtail/log_devices/http.rb#246
...
Logtail::LogDevices::HTTP::DEFAULT_INGESTING_HOST = T.let(T.unsafe(nil), String)

# source://logtail//lib/logtail/log_devices/http.rb#22
Logtail::LogDevices::HTTP::DEFAULT_INGESTING_PORT = T.let(T.unsafe(nil), Integer)

# source://logtail//lib/logtail/log_devices/http.rb#23
Logtail::LogDevices::HTTP::DEFAULT_INGESTING_SCHEME = T.let(T.unsafe(nil), String)
...
class Logtail::Logger < ::Logger
  ...
  # source://logtail//lib/logtail/logger.rb#238

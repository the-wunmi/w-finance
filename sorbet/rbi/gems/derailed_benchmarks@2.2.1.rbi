...
class DerailedBenchmarks::Git::Commit
  ...
  # source://derailed_benchmarks//lib/derailed_benchmarks/git/commit.rb#25
  def desc; end

  # source://derailed_benchmarks//lib/derailed_benchmarks/git/commit.rb#10
  def description; end

  # source://derailed_benchmarks//lib/derailed_benchmarks/git/commit.rb#26
  def file; end
...
#
# source://derailed_benchmarks//lib/derailed_benchmarks/stats_from_dir.rb#33
class DerailedBenchmarks::StatsFromDir
  # @return [StatsFromDir] a new instance of StatsFromDir
  #
  # source://derailed_benchmarks//lib/derailed_benchmarks/stats_from_dir.rb#37
  def initialize(input); end

  # source://derailed_benchmarks//lib/derailed_benchmarks/stats_from_dir.rb#123
  def align; end

  # source://derailed_benchmarks//lib/derailed_benchmarks/stats_from_dir.rb#147
  def banner(io = T.unsafe(nil)); end

  # source://derailed_benchmarks//lib/derailed_benchmarks/stats_from_dir.rb#65
  def call; end

  # source://derailed_benchmarks//lib/derailed_benchmarks/stats_from_dir.rb#115
  def change_direction; end

  # source://derailed_benchmarks//lib/derailed_benchmarks/stats_from_dir.rb#99
  def d_critical; end

  # source://derailed_benchmarks//lib/derailed_benchmarks/stats_from_dir.rb#95
  def d_max; end

  # @return [Boolean]
  #
  # source://derailed_benchmarks//lib/derailed_benchmarks/stats_from_dir.rb#107
  def faster?; end

  # source://derailed_benchmarks//lib/derailed_benchmarks/stats_from_dir.rb#127
  def histogram(io = T.unsafe(nil)); end

  # Returns the value of attribute newest.
  #
  # source://derailed_benchmarks//lib/derailed_benchmarks/stats_from_dir.rb#35
  def newest; end
  ...
  # source://derailed_benchmarks//lib/derailed_benchmarks/stats_from_dir.rb#111
  def percent_faster; end

  # @return [Boolean]
  #
  # source://derailed_benchmarks//lib/derailed_benchmarks/stats_from_dir.rb#91
  def significant?; end

  # source://derailed_benchmarks//lib/derailed_benchmarks/stats_from_dir.rb#83
  ...
  # source://derailed_benchmarks//lib/derailed_benchmarks/stats_from_dir.rb#103
  def x_faster; end
end

# source://derailed_benchmarks//lib/derailed_benchmarks/stats_from_dir.rb#34
